...
export class ModalentradaComponent implements OnInit {
  ...
  constructor(private renderer: Renderer2, private service: ConsultaService, private tools: ToolsService, private dialogRef: MatDialogRef<ModalentradaComponent>, private formBuilder: FormBuilder, @Inject(MAT_DIALOG_DATA)
  public data: {
    entradas: any,
    financiadores: any,
    fentradas: any,
